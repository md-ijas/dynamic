...
?>
    <div class="row portfolio-container gallery-<?php echo $id; ?>">
<?php
    $i = 0;
...
?>
		<div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<?php i18n_gallery_thumb_link($gallery,$item); ?>" class="img-fluid" alt="<?php echo htmlspecialchars(@$item['_title']); ?>">
              <div class="portfolio-info">
                <div class="portfolio-links">
                  <a <?php i18n_gallery_pic_link($gallery,$i); ?>" rel="prettyPhoto[<?php echo $id; ?>]" title="<?php echo htmlspecialchars(@$item['_description']); ?>" data-gall="portfolioGallery" class="venobox" ><i class="bx bx-plus"></i></a>
                </div>
              </div>
            </div>
        </div>
